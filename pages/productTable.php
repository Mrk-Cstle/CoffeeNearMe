...
.product-Header {
  color: #2D2B2B; /* Adjusted for consistency */
...
.modal-dialog {
    max-width: 1400px; /* Adjust to match the view form width */
}
.btn-close{
  background-color: #D9D9D9;
}
...
.prodHeading{
        ...
        .ingredientBody{
            ...
            height: 535px;
            position: absolute;
            top: 80px; /* Adjust this value to move the div down */
            left: 630px; /* Adjust this value as needed */
        }
        .ingredientHeader{
        ...
        .ingredientBtn{
            position: absolute;
            top: 10px; /* Adjust this value to move the div down */
            left: 480px; /* Adjust this value as needed */
        ...
        <form action="">
            ...
            <button type="button" class="topbtn btn btn-dark me-1">Filter</button>
                ...
                <table class="tableProductsInfo" id="products">
                    ...
                    <tbody class="tableProductsInfo">
                        <tr class="tableProductsInfo">
                        <td id="picture"><img src="../assets/images/1x1.jpg" class="fprofile "></td>
                            <td class="tableProductsInfo">Coffee</td>
                            <td class="tableProductsInfo">Nescafe</td>
                            <td class="tableProductsInfo">₱120</td>
                            <td class="tableProductsInfo"><button type="button" id="btn-action" data-bs-toggle="modal" data-bs-target="#viewProductModal">View</button></td>                         </td>
                        ...
                        <td id="picture"><img src="../assets/images/Maloi.jpg" class="fprofile "></td>
                            ...
                            <td class="tableProductsInfo">Nescafe</td>
                            <td class="tableProductsInfo">₱120</td>
                            <td class="tableProductsInfo"><button type="button" id="btn-action" data-bs-toggle="modal" data-bs-target="#viewProductModal">View</button></td>
                            <!-- <button type="button" id="btn-action" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</button></td> -->
                        </tr>
                        <tr class="tableProductsInfo">
                        <td id="picture"><img src="../assets/images/Maloi.jpg" class="fprofile "></td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content viewContent">
            ...
            <div class="productBody">
              <div class="ingredientBody">
                ...
                <div class="ingredientHeaderTwo">
                  ...
                  <div class="ingredientBodyModal modal-body">
                    <ul class="ingredientBodyMowdal list-group">
                  ...
                  <div class="ingredientBodyModal modal-body">
                    <ul class="ingredientBodyMowdal list-group">
                      <li class="ingredientLi list-group-item">Example Ingredient
                        <span class="spanquantity">20</span>
                        <a href="#" class="trashIcon bi bi-trash text-dark"></a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="ingredientBodyModal modal-body">
                    <ul class="ingredientBodyMowdal list-group">
                      <li class="ingredientLi list-group-item">Example Ingredient
                        <span class="spanquantity">30</span>
                        <a href="#" class="trashIcon bi bi-trash text-dark"></a>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="productDetails">
                ...
                <div class="productInput">
                  ...
                  <input type="text" class="productCategory">
                </div>
                <div class="productInput">
      ...
      <div class="modal-footer viewIngredient">
        <button type="button" class="btnIngredient btn btn-secondary" data-dismiss="modal">Close</button>
      ...
      <div class="category modal-body">
        <ul class="list-group">
          ...
          <li class="items list-group-item">Example Category
            <a href="#" class="dots bi bi-trash text-dark"></a>
        </ul> <br>
        <ul class="list-group">
          <!-- Category items will be dynamically inserted here -->
          <!-- Example: -->
